...
public class NLTools {
    ...
    public static TreeMap<ArrayList<String> , ArrayList<String>> POSTag(ArrayList<String> questions) {
        ...
        POSModel model;
        try {
            modelIn = new FileInputStream("F:\\Dev\\Spring\\SpringTry2\\src\\main\\java\\com\\springapp\\mvc\\NLPTools\\en-pos-maxent.bin");
            ...
            for (String question : questions) {
                InputStream modelForToks = new FileInputStream("F:\\Dev\\Spring\\SpringTry2\\src\\main\\java\\com\\springapp\\mvc\\NLPTools\\en-token.bin");
