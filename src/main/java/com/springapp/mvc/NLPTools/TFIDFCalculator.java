 ...
 * Calculates the Tf-FId of the given document in a set of Documents.
 * The tf function and the idff function individually calculate the tf and idf respectively and the tfidf func finally gives th log.
 */
